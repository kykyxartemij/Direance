...
function ArtIconToggle({ icon, pressedIcon, tooltip, pressed: pressedProp, defaultPressed = false, onPressedChange, size = 'md', color, variant = 'ghost', className = '', onClick, ref, ...rest }: ArtIconToggleProps) {
