...
import { useGetLightConnections, useFetchPnlConnectionReports } from '@/hooks/connection.hooks';
...
// connection reports (fetched + built by useFetchPnlConnectionReports), and any manually-
...
export default function PnlPage() {
  ...
  const { data: connectionReports = [] } = useFetchPnlConnectionReports(
    activeConnections,
